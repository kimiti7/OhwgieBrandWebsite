...
import { RealtimePostgresFilterBuilder } from '@supabase/realtime-js/src/RealtimePostgresFilterBuilder';
export type { RealtimePostgresChangesFilterOperator } from '@supabase/realtime-js/src/RealtimePostgresFilterBuilder';
export { RealtimePostgresFilterBuilder, postgresChangesFilter, } from '@supabase/realtime-js/src/RealtimePostgresFilterBuilder';
type ReplayOption = {
    since: number;
    limit?: number;
};
